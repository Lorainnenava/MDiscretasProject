...
return (
  <div className="w-screen h-screen flex bg-[#001f36] text-white overflow-hidden">
    <div className="w-[25%] min-w-[380px] px-8 py-20 flex flex-col justify-start">
      {loadingUsers ? (
    ...
    <div
      ref={containerRef}
      className="relative flex-1 flex items-start justify-center overflow-y-auto overflow-x-hidden p-5 w-full max-w-full"
    >
      {!selectedUser ? (
        <motion.p
